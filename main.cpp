...
#include "subprojects/glm/glm/ext/matrix_transform.hpp"
#include <vulkan/vulkan_core.h>
#define GLFW_INCLUDE_VULKAN
#include "subprojects/glfw/include/GLFW/glfw3.h"
...
#include "subprojects/glm/glm/glm.hpp"
#include "subprojects/glm/glm/gtc/matrix_transform.hpp"
#include <chrono>
#define STB_IMAGE_IMPLEMENTATION
#include"include_stb/stb_image.h"
...
private:
    ...
    void createTextureImage()
    {
        ...
        copyBufferImage(stagingBuffer,textureImage,static_cast<uint32_t>(texWidth),static_cast<uint32_t>(texHeight));
    ...
    void transitionImageLayout(VkImage image,VkFormat format,VkImageLayout oldLayout, VkImageLayout newLayout)
    {
        ...
        {
            throw std::invalid_argument("unsuported layout transistion"); 
        }
                      ...
                      VkBuffer &buffer, VkDeviceMemory &bufferMemory)
    {
        ...
        vkGetBufferMemoryRequirements(device, buffer, &memRequiremets);

        VkMemoryAllocateInfo allocInfo{};
        allocInfo.sType = VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO;
        allocInfo.allocationSize = memRequiremets.size;
        allocInfo.memoryTypeIndex = findMemoryType(memRequiremets.memoryTypeBits, properties);
